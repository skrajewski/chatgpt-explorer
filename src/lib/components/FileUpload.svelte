...
<div class="flex h-full flex-col bg-gray-50">
	...
	<div class="flex-1 p-8">
		<div class="max-w-6xl mx-auto">
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
				...
				<div class="bg-white border-2 border-gray-300 rounded-lg p-8 flex flex-col justify-center">
					<div class="text-center space-y-6">
						<h1 class="text-3xl font-bold text-gray-900">ChatGPT Explorer</h1>
						<div class="space-y-4">
							<p class="text-lg text-gray-700">Browse and search your ChatGPT conversations offline</p>
				...
				<div
					role="button"
					tabindex="0"
					class="upload-area w-full h-full min-h-[300px] rounded-lg border-2 border-dashed p-8 text-center flex flex-col justify-center {isDragOver
			...
			{#if isLoading}
				...
				<div class="mb-4">
					<p class="mb-2 text-lg font-medium text-gray-900">Processing your ChatGPT export...</p>
			...
			{:else}
				...
				<div class="button-group">
					<button type="button" onclick={() => fileInput.click()} class="upload-button primary">
						Choose File
					</button>
					<button type="button" onclick={onSampleDataSelected} class="upload-button secondary">
						Try Sample Data
					</button>
				</div>
					{/if}
	...
	<div class="py-6 text-center border-t border-gray-200 bg-white">
		<p class="text-sm text-gray-600">Built by <a href="https://szymonkrajewski.pl" class="text-blue-600 hover:text-blue-800 underline" target="_blank">skrajewski</a></p>
	</div>
</div>
